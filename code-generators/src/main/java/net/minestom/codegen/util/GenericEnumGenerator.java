...
public class GenericEnumGenerator extends MinestomCodeGenerator {
    ...
    public void generate() {
        ...
        var staticProtocolObjectCN = ClassName.get("net.minestom.server.registry", "StaticProtocolObject");
        TypeSpec.Builder entryEnum = TypeSpec.enumBuilder(entryCN)
                .addSuperinterface(ParameterizedTypeName.get(staticProtocolObjectCN, entryCN))
