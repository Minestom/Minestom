    ...
    public void generate() {
        ...
        fluidClass.addMethod(
                MethodSpec.methodBuilder("getId")
                        ...
                        .addJavadoc("@deprecated use {@link #id()}")
                        .build()
        );
        // Override id method (from ProtocolObject)
        fluidClass.addMethod(
        ...
        fluidClass.addMethod(
                MethodSpec.methodBuilder("getNamespaceID")
                        ...
                        .addStatement("return namespace()")
                        .addModifiers(Modifier.PUBLIC)
                        .addJavadoc("@deprecated use {@link #namespace()}")
                        .build()
        );
        // Override namespace method
        fluidClass.addMethod(
