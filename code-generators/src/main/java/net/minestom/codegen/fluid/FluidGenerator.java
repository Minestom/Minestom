...
public final class FluidGenerator extends MinestomCodeGenerator {
    ...
    public void generate() {
        ...
        final ClassName gameTagType = ClassName.get("net.minestom.server.tags", "GameTag");
        fluidClass.addMethod(
                MethodSpec.methodBuilder("tags")
                        // Set<GameTag<Fluid>>
                        .returns(ParameterizedTypeName.get(setType, ParameterizedTypeName.get(gameTagType, fluidClassName)))
                        .addAnnotation(NotNull.class)
                        .addModifiers(Modifier.PUBLIC, Modifier.STATIC)
                        .addStatement("return $T.FLUIDS", ClassName.get("net.minestom.server.tags", "GameTags"))
                        .build()
        );
