...
public final class FluidGenerator extends MinestomCodeGenerator {
    ...
    public void generate() {
        ...
        TypeSpec.Builder fluidClass = TypeSpec.enumBuilder(fluidClassName)
                ...
                .addSuperinterface(ClassName.get("net.minestom.server.registry", "ProtocolObject"))
                .addSuperinterface(ParameterizedTypeName.get(ClassName.get("net.minestom.server.tags", "GameTagHolder"), fluidClassName))
        ...
        // static field
        final ClassName setType = ClassName.get("java.util", "Set");
        final ClassName tagType = ClassName.get("net.minestom.server.tags", "GameTag");
        final ClassName tagTypeType = ClassName.get("net.minestom.server.tags", "GameTagType");
        final ParameterizedTypeName tagSetType = ParameterizedTypeName.get(setType, ParameterizedTypeName.get(tagType, fluidClassName));
        final ClassName tagLoaderType = ClassName.get("net.minestom.server.tags", "GameTagLoader");
        fluidClass.addField(
                FieldSpec.builder(tagSetType, "TAGS")
                        .addModifiers(Modifier.PRIVATE, Modifier.STATIC, Modifier.FINAL)
                        .initializer("$T.load($T.FLUIDS)", tagLoaderType, tagTypeType)
                        .build()
        );
        ...
        // Override namespace method (ProtocolObject)
        fluidClass.addMethod(
        ...
        // Override id method (ProtocolObject)
        fluidClass.addMethod(
        ...
        // Override tagType method (GameTagHolder)
        fluidClass.addMethod(
                MethodSpec.methodBuilder("tagType")
                        .returns(ParameterizedTypeName.get(tagTypeType, fluidClassName))
                        .addAnnotation(Override.class)
                        .addAnnotation(NotNull.class)
                        .addStatement("return $T.FLUIDS", tagTypeType)
                        .addModifiers(Modifier.PUBLIC)
                        .build()
        );
        // Override tags method (GameTagHolder)
        fluidClass.addMethod(
