...
public class BlockSoundTypesGenerator extends MinestomCodeGenerator {
    ...
    public void generate() {
        ...
        TypeSpec.Builder recordClass = TypeSpec.recordBuilder(recordCN)
                .addJavadoc("AUTOGENERATED by " + getClass().getSimpleName());



        recordClass.recordConstructor(MethodSpec.compactConstructorBuilder()
        ...
        recordClass.addSuperinterface(blockSoundEventCN);

        recordClass.addMethod(
        ...
        writeFiles(
                List.of(
                        JavaFile.builder(packageName, interfaceClass.build())
                                ...
                                .build(),
                        JavaFile.builder(packageName, recordClass.build())
                                .indent("    ")
                                .skipJavaLangImports(true)
                                .build()
                ),
