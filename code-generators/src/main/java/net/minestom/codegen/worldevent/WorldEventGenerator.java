...
public class WorldEventGenerator extends GenericEnumGenerator {
    private static final Logger LOGGER = LoggerFactory.getLogger(WorldEventGenerator.class);

    public WorldEventGenerator(Generators.@NotNull StaticEntry entry, @NotNull File outputFolder) {
        super(entry, outputFolder);
    }

    public WorldEventGenerator(@NotNull String packageName, @NotNull String className, @Nullable InputStream entriesFile, @NotNull File outputFolder) {
