...
public final class BlockGenerator extends MinestomCodeGenerator {
    ...
    public void generate() {
        ...
        CodeBlock.Builder staticRegistrationBlock = CodeBlock.builder();
        // Use data
        for (JsonElement b : blocks) {
            ...
            // Add Block to staticBlock for registration
            staticRegistrationBlock.addStatement("$T.BLOCK_REGISTRY.register($N)", registryClassName, blockName);
        ...
        blocksClass.addStaticBlock(staticRegistrationBlock.build());
        writeFiles(
