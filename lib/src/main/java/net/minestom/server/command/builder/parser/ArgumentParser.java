...
public class ArgumentParser {
    ...
    static {
        ...
        // "command", "entity", "entities", "player", "players", "itemstack" and "component"
        // dispatch against the running server; the framework registers them via registerArgument.
        // TODO enum
    ...
    /**
     * Registers an identifier usable in {@link #generate(String)} format strings.
     * Used by the framework to install its server-bound argument types.
     */
    @ApiStatus.Internal
    public static void registerArgument(String identifier, Function<String, Argument<?>> function) {
