//TODO(valhalla) revert when errorprone supports jdk28 (crashes inside the valhalla javac)
...
tasks.withType<JavaCompile>().configureEach {
    ...
    //TODO(valhalla) drop -preview from the exclusions when jep 401 leaves preview (value class usage warns under -Xlint:all and fails -Werror)
    options.compilerArgs.add("-Xlint:all,-requires-automatic,-requires-transitive-automatic,-exports,-missing-explicit-ctor,-preview")
    //TODO(valhalla) revert when jep 401 leaves preview
    options.compilerArgs.add("--enable-preview")
    //TODO(valhalla) revert when gradle supports jdk28 (incremental analysis cannot parse class file 72)
