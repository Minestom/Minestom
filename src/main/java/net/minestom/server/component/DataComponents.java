...
import net.minestom.server.item.component.BrewingFuel;
import net.minestom.server.item.component.Compostable;
import net.minestom.server.item.component.Consumable;
import net.minestom.server.item.component.CookingFuel;
...
import net.minestom.server.item.component.MobVisibility;
...
import net.minestom.server.item.component.SignText;
...
import net.minestom.server.item.component.VillagerFood;
...
public class DataComponents {
    ...
    public static final DataComponent<SwingAnimation> ATTACK_ANIMATION = register("attack_animation", SwingAnimation.NETWORK_TYPE, SwingAnimation.CODEC);
    public static final DataComponent<SwingAnimation> INTERACT_ANIMATION = register("interact_animation", SwingAnimation.NETWORK_TYPE, SwingAnimation.CODEC);
    ...
    public static final DataComponent<RegistryKey<BlockTransformer>> BLOCK_TRANSFORMER = register("block_transformer", BlockTransformer.NETWORK_TYPE, BlockTransformer.CODEC);
    public static final DataComponent<VillagerFood> VILLAGER_FOOD = register("villager_food", VillagerFood.NETWORK_TYPE, VillagerFood.CODEC);
    ...
    public static final DataComponent<Compostable> COMPOSTABLE = register("compostable", Compostable.NETWORK_TYPE, Compostable.CODEC);
    public static final DataComponent<CookingFuel> COOKING_FUEL = register("cooking_fuel", CookingFuel.NETWORK_TYPE, CookingFuel.CODEC);
    public static final DataComponent<BrewingFuel> BREWING_FUEL = register("brewing_fuel", BrewingFuel.NETWORK_TYPE, BrewingFuel.CODEC);
    public static final DataComponent<MobVisibility> MOB_VISIBILITY = register("mob_visibility", MobVisibility.NETWORK_TYPE, MobVisibility.CODEC);
    ...
    public static final DataComponent<RegistryKey<DecoratedPotPattern>> PROVIDES_POTTERY_PATTERN = register("provides_pottery_pattern", DecoratedPotPattern.NETWORK_TYPE, DecoratedPotPattern.CODEC);
    public static final DataComponent<SignText> SIGN_TEXT_FRONT = register("sign_text_front", SignText.NETWORK_TYPE, SignText.CODEC);
    public static final DataComponent<SignText> SIGN_TEXT_BACK = register("sign_text_back", SignText.NETWORK_TYPE, SignText.CODEC);
    public static final DataComponent<Unit> WAXED = register("waxed", NetworkBuffer.UNIT, Codec.UNIT);
    public static final DataComponent<DyeColor> CUSHION_COLOR = register("cushion/color", DyeColor.NETWORK_TYPE, DyeColor.CODEC);
