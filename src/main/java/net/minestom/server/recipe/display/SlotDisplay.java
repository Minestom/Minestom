...
public sealed interface SlotDisplay extends ComponentHolder<SlotDisplay> {
    ...
    value class Empty implements SlotDisplay {
    ...
    value class AnyFuel implements SlotDisplay {
    ...
    value record WithAnyPotion(SlotDisplay display) implements SlotDisplay {
    ...
    value record OnlyWithComponent(SlotDisplay source, DataComponent<?> component) implements SlotDisplay {
    ...
    value record Item(Material material) implements SlotDisplay {
    ...
    value record ItemStack(net.minestom.server.item.ItemStack itemStack) implements SlotDisplay {
    ...
    value record Tag(TagKey<Material> tag) implements SlotDisplay {
    ...
    value record Dyed(SlotDisplay dye, SlotDisplay target) implements SlotDisplay {
    ...
    value record WithRemainder(SlotDisplay input, SlotDisplay remainder) implements SlotDisplay {
    ...
    value record Composite(List<SlotDisplay> contents) implements SlotDisplay {
