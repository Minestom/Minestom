...
public final class ServerFlag {
    ...
    public static final boolean IMMUTABLE_SERVER_PROCESS = booleanProperty("minestom.immutable-server-process", true);
    ...
    // Registries
    public static final boolean REGISTRY_FREEZING_TAGS = booleanProperty("minestom.registry.freezing-tags", false);
