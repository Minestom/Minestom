...
public class BlockPlacementListener {
    ...
    public static void listener(ClientPlayerBlockPlacementPacket packet, Player player) {
        ...
        boolean intersectPlayer = placedBlock.registry().shape().intersectBox(player.getPosition().sub(placementPosition), player.getBoundingBox());
        ...
        boolean hasIntersect = intersectPlayer || entities
                ...
                .anyMatch(entity -> placedBlock.registry().shape().intersectBox(entity.getPosition().sub(placementPosition), entity.getBoundingBox()));
