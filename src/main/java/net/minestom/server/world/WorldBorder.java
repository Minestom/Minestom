...
/**
 * Represents the world border of an {@link World},
 * can be retrieved with {@link World#getWorldBorder()}.
 */
public class WorldBorder {
    ...
    protected WorldBorder(@NotNull World world) {
        this.world = world;
     ...
     * Called in the World tick update.
     */
    ...
    /**
     * Gets the {@link World} linked to this world border.
     *
     * @return the {@link World} of this world border
     */
    @NotNull
    ...
    /**
     * Sends the new world border centers to all playersin the World.
     */
