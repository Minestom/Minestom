 ...
 * <p>
 * See {@link MinestomBasicChunkLoader} for the default implementation used in {@link WorldContainer}.
 */
public interface IChunkLoader {
     ...
     *
     * @param world    the {@link World} where the {@link Chunk} belong
     ...
     */
    boolean loadChunk(@NotNull World world, int chunkX, int chunkZ, @Nullable ChunkCallback callback);
