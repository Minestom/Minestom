...
public class DynamicChunk extends Chunk {
    ...
    public DynamicChunk(@NotNull World world, @Nullable Biome[] biomes, int chunkX, int chunkZ) {
        super(world, biomes, chunkX, chunkZ, true);
    }
    ...
    @NotNull
    @Override
    public Chunk copy(@NotNull World world, int chunkX, int chunkZ) {
        DynamicChunk dynamicChunk = new DynamicChunk(world, biomes.clone(), chunkX, chunkZ);
