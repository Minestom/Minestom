...
/**
 * Represents a message which can be sent using the [NotificationCenter].
 */
class Notification {
    constructor(title: Component, frameType: FrameType, icon: Material) : this(title, frameType, ItemStack.of(icon)) {}
