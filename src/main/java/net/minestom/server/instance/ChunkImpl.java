...
final class ChunkImpl implements Chunk {
    ...
    static final long NO_FLAGS = 0L;
    static final long LIGHT_ENGINE_FLAG = 1L;  // Automatically compute light updates
    static final long READONLY_FLAG = 1L << 1; // Prevent block mutation
    static final long GENERATE_FLAG = 1L << 2; // Allow the chunk to be generated by a {@link Generator}.
    ...
    static final class Builder implements Chunk.Builder {
        ...
        @Override
        public void generate(boolean generate) {
