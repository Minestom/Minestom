...
public interface IChunkLoader {
     ...
     */
    CompletableFuture<Chunk> loadChunk(@NotNull Instance instance, int chunkX, int chunkZ);
     ...
     * Can be null.
     */
    default CompletableFuture<Void> saveChunks(@NotNull Collection<Chunk> chunks) {
