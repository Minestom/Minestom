...
public record ClientPlayerBlockPlacementPacket(LivingEntity.@NotNull Hand hand, @NotNull Point blockPosition,
    ...
    public ClientPlayerBlockPlacementPacket(@NotNull NetworkBuffer reader) {
        this(reader.readEnum(LivingEntity.Hand.class), reader.read(BLOCK_POSITION),
