...
public interface PacketRegistry<T> {
    ...
    PacketRegistry<ClientPacket.Handshake> CLIENT_HANDSHAKE = registry(ConnectionState.HANDSHAKE, ConnectionSide.CLIENT,
            entry(ClientHandshakePacket.class, ClientHandshakePacket.SERIALIZER)
    );

    PacketRegistry<ClientPacket.Status> CLIENT_STATUS = registry(ConnectionState.STATUS, ConnectionSide.CLIENT,
    ...
    PacketRegistry<ClientPacket.Login> CLIENT_LOGIN = registry(ConnectionState.LOGIN, ConnectionSide.CLIENT,
    ...
    PacketRegistry<ClientPacket.Configuration> CLIENT_CONFIGURATION = registry(ConnectionState.CONFIGURATION, ConnectionSide.CLIENT,
    ...
    PacketRegistry<ClientPacket.Play> CLIENT_PLAY = PacketRegistry.<ClientPacket.Play>registry(ConnectionState.PLAY, ConnectionSide.CLIENT,
    ...
    PacketRegistry<ServerPacket.Handshake> SERVER_HANDSHAKE = registry(ConnectionState.HANDSHAKE, ConnectionSide.SERVER);

    PacketRegistry<ServerPacket.Status> SERVER_STATUS = registry(ConnectionState.STATUS, ConnectionSide.SERVER,
            entry(ResponsePacket.class, ResponsePacket.SERIALIZER),
            entry(PingResponsePacket.class, PingResponsePacket.SERIALIZER)
    );

    PacketRegistry<ServerPacket.Login> SERVER_LOGIN = registry(ConnectionState.LOGIN, ConnectionSide.SERVER,
    ...
    PacketRegistry<ServerPacket.Configuration> SERVER_CONFIGURATION = registry(ConnectionState.CONFIGURATION, ConnectionSide.SERVER,
            entry(CookieRequestPacket.class, CookieRequestPacket.SERIALIZER),
    ...
    PacketRegistry<ServerPacket.Play> SERVER_PLAY = PacketRegistry.<ServerPacket.Play>registry(ConnectionState.PLAY, ConnectionSide.SERVER,
