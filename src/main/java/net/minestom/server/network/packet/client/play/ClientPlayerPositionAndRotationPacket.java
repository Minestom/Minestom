...
public record ClientPlayerPositionAndRotationPacket(Pos position, @MagicConstant(flagsFromClass = ClientPlayerPositionAndRotationPacket.class) byte flags) implements ClientPacket.Play {
