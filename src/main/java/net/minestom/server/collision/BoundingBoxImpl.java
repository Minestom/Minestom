 ...
 */
public class BoundingBoxImpl implements BoundingBox, Collidable {
    ...
    public BoundingBoxImpl(double width, double height, double depth) {
        this.width = width;
        this.height = height;
        this.depth = depth;
    ...
    /**
     * Used to know if two {@link BoundingBoxImpl} intersect with each other.
     *
     * @param entityBoundingBox the {@link BoundingBoxImpl} to check
     * @return true if the two {@link BoundingBoxImpl} intersect with each other, false otherwise
     */
    ...
    /**
     * Used to know if this {@link BoundingBoxImpl} intersects with the bounding box of an entity.
     *
    ...
    /**
     * Creates a new {@link BoundingBoxImpl} linked to the same {@link Entity} with expanded size.
     *
     * @param x the X offset
     * @param y the Y offset
     * @param z the Z offset
     * @return a new {@link BoundingBoxImpl} expanded
     */
    public @NotNull BoundingBoxImpl expand(double x, double y, double z) {
        return new BoundingBoxImpl(this.width + x, this.height + y, this.depth + z);
    }

    /**
     * Creates a new {@link BoundingBoxImpl} linked to the same {@link Entity} with contracted size.
     *
     * @param x the X offset
     * @param y the Y offset
     * @param z the Z offset
     ...
     */
    public @NotNull BoundingBoxImpl contract(double x, double y, double z) {
        return new BoundingBoxImpl(this.width - x, this.height - y, this.depth - z) ;
    }
