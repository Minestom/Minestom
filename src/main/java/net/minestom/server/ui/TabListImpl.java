...
record TabListImpl(Component header, Component footer, boolean hasPlayerList,
                   List<Component> beforeText, List<PlayerSkin> beforeSkin,
                   List<Component> afterText, List<PlayerSkin> afterSkin) implements TabList {
    ...
    static final class Builder implements TabList.Builder {
        ...
        public @NotNull TabList build() {
            return new TabListImpl(header, footer, hasPlayerList,
