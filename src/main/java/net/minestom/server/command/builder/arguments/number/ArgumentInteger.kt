...
class ArgumentInteger(id: String) : ArgumentNumber<Int?>(
    id,
    "brigadier:integer",
    ...
    BiConsumer { obj: BinaryWriter, i: Int? -> obj.writeInt(i!!) },
    java.util.Comparator { x: Int?, y: Int? ->
        Integer.compare(
            x!!, y!!
        )
    }) {
    override fun toString(): String {
        return String.format("Integer<%s>", id)
    }
}