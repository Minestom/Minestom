...
public class PlayerOnlyCondition implements ExecuteCondition {
    protected Component message = Component.text("The command is only available for players", NamedTextColor.RED);
