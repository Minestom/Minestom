 ...
 * Example: 5 ~ -3
 */
class ArgumentRelativeBlockPosition(id: String) : ArgumentRelativeVec(id, 3) {
    ...
    override fun toString(): String {
        return String.format("RelativeBlockPosition<%s>", id)
    }
    ...
    override val absoluteNumberParser: Function<String, out Number>
        get() = Function<String, Number> { s: String -> s.toInt() }
}