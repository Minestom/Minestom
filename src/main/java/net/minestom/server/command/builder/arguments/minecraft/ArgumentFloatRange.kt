 ...
 * Example: ..3, 3.., 5..10, 15
 */
class ArgumentFloatRange(id: String) : ArgumentRange<FloatRange?, Float?>(
    id,
    "minecraft:float_range",
    Float.MIN_VALUE,
    Float.MAX_VALUE,
    Function { s: String -> s.toFloat() },
    BiFunction { minimum: Float?, maximum: Float? -> FloatRange(minimum, maximum) }) {
    override fun toString(): String {
        return String.format("FloatRange<%s>", id)
    }
}