 ...
 */
class ArgumentPotionEffect(id: String) : ArgumentRegistry<PotionEffect?>(id) {
    override fun getRegistry(value: String): PotionEffect? {
    ...
    override fun toString(): String {
        return String.format("Potion<%s>", id)
    }
}