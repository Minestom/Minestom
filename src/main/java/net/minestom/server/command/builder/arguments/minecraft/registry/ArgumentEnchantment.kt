 ...
 */
class ArgumentEnchantment(id: String) : ArgumentRegistry<Enchantment?>(id) {
    override fun getRegistry(value: String): Enchantment? {
    ...
    override fun toString(): String {
        return String.format("Enchantment<%s>", id)
    }
}