...
/**
 * Used to know if the sender or origin is allowed to run the command or a specific syntax.
 */
@FunctionalInterface
public interface CommandCondition {

    /**
     * Called when the origin's identity, their permissions, or the provided command needs to be checked to see if it
     * will run.<br>
     ...
     */
    boolean canUse(@NotNull CommandOrigin origin, @Nullable String command, int startingPosition);
