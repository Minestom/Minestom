 ...
 * Example: ..3, 3.., 5..10, 15
 */
class ArgumentIntRange(id: String) : ArgumentRange<net.minestom.server.utils.math.IntRange?, Int?>(
    id,
    "minecraft:int_range",
    Int.MIN_VALUE,
    Int.MAX_VALUE,
    Function { s: String -> s.toInt() },
    BiFunction { minimum: Int?, maximum: Int? ->
        IntRange(
            minimum!!, maximum!!
        )
    }) {
    override fun toString(): String {
        return String.format("IntRange<%s>", id)
    }
}