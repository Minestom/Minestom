...
class ArgumentLong(id: String) : ArgumentNumber<Long?>(
    id,
    "brigadier:long",
    ...
    BiConsumer { obj: BinaryWriter, l: Long? -> obj.writeLong(l!!) },
    java.util.Comparator { x: Long?, y: Long? ->
        java.lang.Long.compare(
            x!!, y!!
        )
    }) {
    override fun toString(): String {
        return String.format("Long<%s>", id)
    }
}