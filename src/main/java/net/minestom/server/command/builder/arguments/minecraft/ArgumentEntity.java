...
public class ArgumentEntity extends Argument<EntityFinder> {
    ...
    private static int parseArgument(@NotNull CommandSender sender,
        ...
        switch (argumentName) {
            ...
            case "level":
                try {
                    final Range.Integer level = Argument.parse(sender, new ArgumentIntRange(value));
            ...
            case "distance":
                try {
                    final Range.Integer distance = Argument.parse(sender, new ArgumentIntRange(value));
