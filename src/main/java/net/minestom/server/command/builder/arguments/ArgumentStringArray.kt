 ...
 */
class ArgumentStringArray(id: String) : Argument<Array<String>>(id, true, true) {
    override fun parse(input: String): Array<String> {
        return input.split(Pattern.quote(StringUtils.SPACE)).toTypedArray()
    }
    ...
    override fun toString(): String {
        return String.format("StringArray<%s>", id)
    }
}