 ...
 * Example: true
 */
class ArgumentBoolean(id: String) : Argument<Boolean>(id) {
    ...
    override fun parse(input: String): Boolean {
        ...
        throw ArgumentSyntaxException("Not a boolean", input, NOT_BOOLEAN_ERROR)
    }
    ...
    override fun toString(): String {
        return String.format("Boolean<%s>", id)
    }

    companion object {
        const val NOT_BOOLEAN_ERROR = 1
    }
}