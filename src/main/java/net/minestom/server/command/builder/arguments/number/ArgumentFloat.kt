...
class ArgumentFloat(id: String) : ArgumentNumber<Float?>(
    id,
    "brigadier:float",
    ...
    BiConsumer { obj: BinaryWriter, f: Float? -> obj.writeFloat(f!!) },
    java.util.Comparator { f1: Float?, f2: Float? ->
        java.lang.Float.compare(
            f1!!, f2!!
        )
    }) {
    override fun toString(): String {
        return String.format("Float<%s>", id)
    }
}