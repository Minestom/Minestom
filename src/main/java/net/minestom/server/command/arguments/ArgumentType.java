package net.minestom.server.command.arguments;

import net.minestom.server.command.arguments.minecraft.ArgumentBlockState;
import net.minestom.server.command.arguments.minecraft.ArgumentColor;
import net.minestom.server.command.arguments.minecraft.ArgumentComponent;
import net.minestom.server.command.arguments.minecraft.ArgumentEntity;
import net.minestom.server.command.arguments.minecraft.ArgumentFloatRange;
import net.minestom.server.command.arguments.minecraft.ArgumentIntRange;
import net.minestom.server.command.arguments.minecraft.ArgumentItemStack;
import net.minestom.server.command.arguments.minecraft.ArgumentNbtCompoundTag;
import net.minestom.server.command.arguments.minecraft.ArgumentNbtTag;
import net.minestom.server.command.arguments.minecraft.ArgumentResource;
import net.minestom.server.command.arguments.minecraft.ArgumentResourceLocation;
import net.minestom.server.command.arguments.minecraft.ArgumentResourceOrTag;
import net.minestom.server.command.arguments.minecraft.ArgumentTime;
import net.minestom.server.command.arguments.minecraft.ArgumentUUID;
import net.minestom.server.command.builder.arguments.minecraft.*;
import net.minestom.server.command.arguments.minecraft.registry.ArgumentEnchantment;
import net.minestom.server.command.arguments.minecraft.registry.ArgumentEntityType;
import net.minestom.server.command.arguments.minecraft.registry.ArgumentParticle;
import net.minestom.server.command.arguments.number.ArgumentDouble;
import net.minestom.server.command.arguments.number.ArgumentFloat;
import net.minestom.server.command.arguments.number.ArgumentInteger;
import net.minestom.server.command.arguments.number.ArgumentLong;
import net.minestom.server.command.arguments.relative.ArgumentRelativeBlockPosition;
import net.minestom.server.command.arguments.relative.ArgumentRelativeVec2;
import net.minestom.server.command.arguments.relative.ArgumentRelativeVec3;
