...
class EndermanMeta(entity: Entity, metadata: Metadata) : MonsterMeta(entity, metadata) {
    fun getCarriedBlockID(): Int {
        return super.metadata.getIndex<Int>(OFFSET.toInt(), null)
    }

    fun setCarriedBlockID(value: Int?) {
        super.metadata.setIndex(OFFSET.toInt(), Metadata.OptBlockID(value))
    }
    ...
    fun setScreaming(value: Boolean) {
