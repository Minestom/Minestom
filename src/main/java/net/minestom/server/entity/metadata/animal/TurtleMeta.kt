...
class TurtleMeta(entity: Entity, metadata: Metadata) : AnimalMeta(entity, metadata) {
    fun getHomePosition(): Point {
        return super.metadata.getIndex(OFFSET.toInt(), Vec.ZERO)
    }

    fun setBlockPosition(value: Point) {
        super.metadata.setIndex(OFFSET.toInt(), Metadata.Position(value))
    }
    ...
    fun setLayingEgg(value: Boolean) {
        super.metadata.setIndex(OFFSET + 2, Metadata.Boolean(value))
    }

    fun getTravelPosition(): Point {
        return super.metadata.getIndex(OFFSET + 3, Vec.ZERO)
    }

    fun setTravelPosition(value: Point) {
    ...
    fun setGoingHome(value: Boolean) {
    ...
    fun setTravelling(value: Boolean) {
