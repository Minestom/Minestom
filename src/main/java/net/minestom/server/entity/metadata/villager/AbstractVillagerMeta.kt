...
open class AbstractVillagerMeta protected constructor(entity: Entity, metadata: Metadata) :
    AgeableMobMeta(entity, metadata) {
    fun getHeadShakeTimer(): Int {
        return super.metadata.getIndex(OFFSET.toInt(), 0)
    }

    fun setHeadShakeTimer(value: Int) {
        super.metadata.setIndex(OFFSET.toInt(), Metadata.VarInt(value))
    }

    companion object {
        val OFFSET: Byte = AgeableMobMeta.Companion.MAX_OFFSET
