...
class CatMeta(entity: Entity, metadata: Metadata) : TameableAnimalMeta(entity, metadata) {
    fun getColor(): Color {
        return Color.VALUES[super.metadata.getIndex(OFFSET.toInt(), 1)]
    }
    ...
    fun setLying(value: Boolean) {
        super.metadata.setIndex(OFFSET + 1, Metadata.Boolean(value))
    }

    fun isRelaxed(): Boolean {
    ...
    fun getCollarColor(): Int {
        return super.metadata.getIndex(OFFSET + 3, 14)
    }

    fun setCollarColor(value: Int) {
    ...
    companion object {
        val OFFSET: Byte = TameableAnimalMeta.Companion.MAX_OFFSET
