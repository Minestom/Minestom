...
class WitchMeta(entity: Entity, metadata: Metadata) : RaiderMeta(entity, metadata) {
    fun isDrinkingPotion(): Boolean {
        return super.metadata.getIndex(OFFSET.toInt(), false)
    }

    fun setDrinkingPotion(value: Boolean) {
        super.metadata.setIndex(OFFSET.toInt(), Metadata.Boolean(value))
    }

    companion object {
        val OFFSET: Byte = RaiderMeta.Companion.MAX_OFFSET
