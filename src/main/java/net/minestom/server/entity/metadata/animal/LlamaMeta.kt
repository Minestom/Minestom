...
class LlamaMeta(entity: Entity, metadata: Metadata) : ChestedHorseMeta(entity, metadata) {
    fun getStrength(): Int {
    ...
    fun getCarpetColor(): Int {
        return super.metadata.getIndex(OFFSET + 1, -1)
    }

    fun setCarpetColor(value: Int) {
    ...
    companion object {
        val OFFSET: Byte = ChestedHorseMeta.Companion.MAX_OFFSET
