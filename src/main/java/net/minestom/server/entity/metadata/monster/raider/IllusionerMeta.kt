...
class IllusionerMeta(entity: Entity, metadata: Metadata) : SpellcasterIllagerMeta(entity, metadata) {
    companion object {
        val OFFSET: Byte = SpellcasterIllagerMeta.Companion.MAX_OFFSET
