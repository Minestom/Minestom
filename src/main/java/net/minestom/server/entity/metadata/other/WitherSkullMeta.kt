...
class WitherSkullMeta(entity: Entity, metadata: Metadata) : EntityMeta(entity, metadata), ObjectDataProvider,
    ProjectileMeta {
    ...
    override fun setShooter(shooter: Entity?) {
        this.shooter = shooter
    }

    override fun getObjectData(): Int {
        return if (shooter == null) 0 else shooter.getEntityId()
    }
