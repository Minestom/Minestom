...
class SmallFireballMeta(entity: Entity, metadata: Metadata) :
    ItemContainingMeta(entity, metadata, Material.FIRE_CHARGE), ObjectDataProvider, ProjectileMeta {
    override var shooter: Entity? = null
    override val objectData: Int
        get() = if (shooter == null) 0 else shooter!!.entityId
