...
class ThrownTridentMeta(entity: Entity, metadata: Metadata) : AbstractArrowMeta(entity, metadata) {
    var loyaltyLevel: Int
        get() = super.metadata.getIndex(OFFSET.toInt(), 0)
        set(value) {
            super.metadata.setIndex(OFFSET.toInt(), Metadata.VarInt(value))
        }
    var isHasEnchantmentGlint: Boolean
        get() = super.metadata.getIndex(OFFSET + 1, false)
        set(value) {
