...
value record WolfVariantImpl(Assets assets, Assets babyAssets) implements WolfVariant {
    WolfVariantImpl {
    ...
    value record AssetsImpl(Key wild, Key tame, Key angry) implements WolfVariant.Assets {
        public AssetsImpl {
