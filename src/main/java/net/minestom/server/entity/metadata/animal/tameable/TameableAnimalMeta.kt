...
open class TameableAnimalMeta protected constructor(entity: Entity, metadata: Metadata) : AnimalMeta(entity, metadata) {
    fun isSitting(): Boolean {
        return getMaskBit(OFFSET.toInt(), SITTING_BIT)
    }

    fun setSitting(value: Boolean) {
        setMaskBit(OFFSET.toInt(), SITTING_BIT, value)
    }
    ...
    companion object {
        ...
        private const val TAMED_BIT: Byte = 0x04
    }
}