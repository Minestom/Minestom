...
class HopperMinecartMeta(entity: Entity, metadata: Metadata) : AbstractMinecartContainerMeta(entity, metadata) {
    override fun getObjectData(): Int {
        return 5
    }

    companion object {
        val OFFSET: Byte = AbstractMinecartContainerMeta.Companion.MAX_OFFSET
