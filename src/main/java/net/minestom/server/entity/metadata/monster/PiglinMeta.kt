...
class PiglinMeta(entity: Entity, metadata: Metadata) : BasePiglinMeta(entity, metadata) {
    fun isBaby(): Boolean {
    ...
    fun setChargingCrossbow(value: Boolean) {
    ...
    fun setDancing(value: Boolean) {
        super.metadata.setIndex(OFFSET + 2, Metadata.Boolean(value))
    }

    companion object {
        val OFFSET: Byte = BasePiglinMeta.Companion.MAX_OFFSET
