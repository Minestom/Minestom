...
open class AgeableMobMeta protected constructor(entity: Entity, metadata: Metadata) :
    PathfinderMobMeta(entity, metadata) {
    fun isBaby(): Boolean {
    ...
    companion object {
        val OFFSET: Byte = PathfinderMobMeta.Companion.MAX_OFFSET
