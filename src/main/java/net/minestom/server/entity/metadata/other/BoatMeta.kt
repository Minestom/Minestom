...
class BoatMeta(entity: Entity, metadata: Metadata) : EntityMeta(entity, metadata) {
    var timeSinceLastHit: Int
    ...
    var forwardDirection: Int
        get() = super.metadata.getIndex(OFFSET + 1, 1)
        set(value) {
