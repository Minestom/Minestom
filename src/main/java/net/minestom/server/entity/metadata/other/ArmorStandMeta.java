...
public class ArmorStandMeta extends LivingEntityMeta {
    ...
    public ArmorStandMeta(@NotNull Entity entity) {
        super(entity);
    }
    ...
    public Vector getHeadRotation() {
        return getMetadata().getIndex((byte) 15, new Vector(0D, 0D, 0D));
    }

    public void setHeadRotation(@NotNull Vector value) {
        getMetadata().setIndex((byte) 15, Metadata.Rotation(value));
    }

    @NotNull
    public Vector getBodyRotation() {
        return getMetadata().getIndex((byte) 16, new Vector(0D, 0D, 0D));
    }

    public void setBodyRotation(@NotNull Vector value) {
        getMetadata().setIndex((byte) 16, Metadata.Rotation(value));
    }

    @NotNull
    public Vector getLeftArmRotation() {
        return getMetadata().getIndex((byte) 17, new Vector(-10D, 0D, -10D));
    }

    public void setLeftArmRotation(@NotNull Vector value) {
        getMetadata().setIndex((byte) 17, Metadata.Rotation(value));
    }

    @NotNull
    public Vector getRightArmRotation() {
        return getMetadata().getIndex((byte) 18, new Vector(-15D, 0D, 10D));
    }

    public void setRightArmRotation(@NotNull Vector value) {
        getMetadata().setIndex((byte) 18, Metadata.Rotation(value));
    }

    @NotNull
    public Vector getLeftLegRotation() {
        return getMetadata().getIndex((byte) 19, new Vector(-1D, 0D, -1D));
    }

    public void setLeftLegRotation(@NotNull Vector value) {
        getMetadata().setIndex((byte) 19, Metadata.Rotation(value));
    }

    @NotNull
    public Vector getRightLegRotation() {
        return getMetadata().getIndex((byte) 20, new Vector(1D, 0D, 1D));
    }

    public void setRightLegRotation(@NotNull Vector value) {
        getMetadata().setIndex((byte) 20, Metadata.Rotation(value));
    }
