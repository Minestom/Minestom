...
class AreaEffectCloudMeta(entity: Entity, metadata: Metadata) : EntityMeta(entity, metadata) {
    fun getRadius(): Float {
        return super.metadata.getIndex(OFFSET.toInt(), .5f)
    }
    ...
    fun setSinglePoint(value: Boolean) {
