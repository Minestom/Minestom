...
class WitherSkeletonMeta(entity: Entity, metadata: Metadata) : AbstractSkeletonMeta(entity, metadata) {
    companion object {
        val OFFSET: Byte = AbstractSkeletonMeta.Companion.MAX_OFFSET
