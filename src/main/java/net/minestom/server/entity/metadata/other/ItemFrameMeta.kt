...
open class ItemFrameMeta(entity: Entity, metadata: Metadata) : EntityMeta(entity, metadata), ObjectDataProvider {
    /**
    ...
    var item: ItemStack
        get() = super.metadata.getIndex(OFFSET.toInt(), ItemStack.AIR)
        set(value) {
            super.metadata.setIndex(OFFSET.toInt(), Metadata.Slot(value))
        }
    var rotation: Rotation
        get() = Rotation.values()[super.metadata.getIndex(OFFSET + 1, 0)]
        set(value) {
