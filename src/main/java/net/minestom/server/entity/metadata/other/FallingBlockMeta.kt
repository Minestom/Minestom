...
class FallingBlockMeta(entity: Entity, metadata: Metadata) : EntityMeta(entity, metadata), ObjectDataProvider {
    private var block = Block.STONE
    fun getSpawnPosition(): Point {
        return super.metadata.getIndex(OFFSET.toInt(), Vec.ZERO)
    }

    fun setSpawnPosition(value: Point?) {
