...
class EndCrystalMeta(entity: Entity, metadata: Metadata) : EntityMeta(entity, metadata) {
    fun getBeamTarget(): Point? {
        return super.metadata.getIndex<Point>(OFFSET.toInt(), null)
    }

    fun setBeamTarget(value: Point?) {
        super.metadata.setIndex(OFFSET.toInt(), Metadata.OptPosition(value))
    }
    ...
    fun setShowingBottom(value: Boolean) {
