...
public final class NavigatorImpl implements Navigator {
    ...
    public NavigatorImpl(Entity entity) {
        this.entity = entity;
    ...
    @Override
    public synchronized boolean setPathTo(@Nullable Point point, double reachRange, double maxDistance, double pathVariance, @Nullable Runnable onComplete) {
        ...
        this.minimumDistance = reachRange;
        if (this.entity.getPosition().distance(point) < reachRange) {
