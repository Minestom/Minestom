...
final class MetadataImpl {
    ...
    static {
        ...
        _EMPTY_VALUES.set(TYPE_COW_VARIANT, CowVariant(CowVariant.TEMPERATE));
        _EMPTY_VALUES.set(TYPE_WOLF_VARIANT, WolfVariant(WolfVariant.PALE));
        _EMPTY_VALUES.set(TYPE_WOLF_SOUND_VARIANT, WolfSoundVariant(WolfSoundVariant.CLASSIC));
        _EMPTY_VALUES.set(TYPE_FROG_VARIANT, FrogVariant(FrogMeta.Variant.TEMPERATE));
        _EMPTY_VALUES.set(TYPE_PIG_VARIANT, PigVariant(PigVariant.TEMPERATE));
        _EMPTY_VALUES.set(TYPE_CHICKEN_VARIANT, ChickenVariant(ChickenVariant.TEMPERATE));
