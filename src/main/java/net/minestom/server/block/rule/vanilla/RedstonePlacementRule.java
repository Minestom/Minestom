...
public class RedstonePlacementRule extends BlockPlacementRule {
    ...
    public @NotNull Block blockUpdate(@NotNull World world, @NotNull BlockPosition blockPosition, @NotNull Block block) {
        BlockUtils blockUtils = new BlockUtils(world, blockPosition);
    ...
    public Block blockPlace(@NotNull World world,
                            ...
                            @NotNull Player pl) {
        final Block belowBlock = world.getBlock(blockPosition.getX(), blockPosition.getY() - 1, blockPosition.getZ());
