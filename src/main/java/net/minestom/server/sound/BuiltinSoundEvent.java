...
record BuiltinSoundEvent(NamespaceID namespace, int id) implements StaticProtocolObject, SoundEvent {
    private static final StaticRegistryData.Container<BuiltinSoundEvent> CONTAINER = StaticRegistryData.createStaticContainer(StaticRegistryData.Resource.SOUNDS,
