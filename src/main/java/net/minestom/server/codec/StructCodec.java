...
public final class StructCodec {

    public static <R> Codec<R> struct(Supplier<R> ctor) {
        return new Codec<>() {
            @Override
            ...
            @Override
            public <D> @NotNull Result<D> encode(@NotNull Transcoder<D> coder, @UnknownNullability R value) {
                return new Result.Ok<>(coder.createNull());
            }
        };
    }

    public static <R, P1> Codec<R> struct(
        ...
        return new Codec<>() {
            @Override
            public @NotNull <D> Result<R> decode(@NotNull Transcoder<D> coder, @NotNull D value) {
                final Result<P1> result1 = get(coder, codec1, name1, value);
    ...
    public static <R, P1, P2> Codec<R> struct(
            String name1, Codec<P1> codec1, Function<R, P1> getter1,
        ...
        return new Codec<>() {
            ...
            public @NotNull <D> Result<R> decode(@NotNull Transcoder<D> coder, @NotNull D value) {
                ...
                if (!(result1 instanceof Result.Ok(P1 value1)))
                    return result1.cast();
                final Result<P2> result2 = get(coder, codec2, name2, value);
    ...
    public static <R, P1, P2, P3> Codec<R> struct(
            String name1, Codec<P1> codec1, Function<R, P1> getter1,
            String name2, Codec<P2> codec2, Function<R, P2> getter2,
        ...
        return new Codec<>() {
            ...
            public @NotNull <D> Result<R> decode(@NotNull Transcoder<D> coder, @NotNull D value) {
                ...
                if (!(result2 instanceof Result.Ok(P2 value2)))
                    return result2.cast();
                final Result<P3> result3 = get(coder, codec3, name3, value);
    ...
    public static <R, P1, P2, P3, P4> Codec<R> struct(
            String name1, Codec<P1> codec1, Function<R, P1> getter1,
            String name2, Codec<P2> codec2, Function<R, P2> getter2,
            String name3, Codec<P3> codec3, Function<R, P3> getter3,
        ...
        return new Codec<>() {
            ...
            public @NotNull <D> Result<R> decode(@NotNull Transcoder<D> coder, @NotNull D value) {
                ...
                if (!(result3 instanceof Result.Ok(P3 value3)))
                    return result3.cast();
                final Result<P4> result4 = get(coder, codec4, name4, value);
    ...
    public static <R, P1, P2, P3, P4, P5> Codec<R> struct(
            String name1, Codec<P1> codec1, Function<R, P1> getter1,
            String name2, Codec<P2> codec2, Function<R, P2> getter2,
            String name3, Codec<P3> codec3, Function<R, P3> getter3,
            String name4, Codec<P4> codec4, Function<R, P4> getter4,
        ...
        return new Codec<>() {
            ...
            public @NotNull <D> Result<R> decode(@NotNull Transcoder<D> coder, @NotNull D value) {
                ...
                if (!(result4 instanceof Result.Ok(P4 value4)))
                    return result4.cast();
                final Result<P5> result5 = get(coder, codec5, name5, value);
    ...
    public static <R, P1, P2, P3, P4, P5, P6> Codec<R> struct(
            String name1, Codec<P1> codec1, Function<R, P1> getter1,
            String name2, Codec<P2> codec2, Function<R, P2> getter2,
            String name3, Codec<P3> codec3, Function<R, P3> getter3,
            String name4, Codec<P4> codec4, Function<R, P4> getter4,
        ...
        return new Codec<>() {
            ...
            public @NotNull <D> Result<R> decode(@NotNull Transcoder<D> coder, @NotNull D value) {
                ...
                if (!(result5 instanceof Result.Ok(P5 value5)))
                    return result5.cast();
                final Result<P6> result6 = get(coder, codec6, name6, value);
    ...
    public static <R, P1, P2, P3, P4, P5, P6, P7> Codec<R> struct(
            String name1, Codec<P1> codec1, Function<R, P1> getter1,
            String name2, Codec<P2> codec2, Function<R, P2> getter2,
            String name3, Codec<P3> codec3, Function<R, P3> getter3,
            String name4, Codec<P4> codec4, Function<R, P4> getter4,
        ...
        return new Codec<>() {
            ...
            public @NotNull <D> Result<R> decode(@NotNull Transcoder<D> coder, @NotNull D value) {
                ...
                if (!(result6 instanceof Result.Ok(P6 value6)))
                    return result6.cast();
                final Result<P7> result7 = get(coder, codec7, name7, value);
    ...
    public static <R, P1, P2, P3, P4, P5, P6, P7, P8> Codec<R> struct(
            String name1, Codec<P1> codec1, Function<R, P1> getter1,
            String name2, Codec<P2> codec2, Function<R, P2> getter2,
            String name3, Codec<P3> codec3, Function<R, P3> getter3,
            String name4, Codec<P4> codec4, Function<R, P4> getter4,
        ...
        return new Codec<>() {
            ...
            public @NotNull <D> Result<R> decode(@NotNull Transcoder<D> coder, @NotNull D value) {
                ...
                if (!(result7 instanceof Result.Ok(P7 value7)))
                    return result7.cast();
                final Result<P8> result8 = get(coder, codec8, name8, value);
    ...
    public static <R, P1, P2, P3, P4, P5, P6, P7, P8, P9> Codec<R> struct(
            String name1, Codec<P1> codec1, Function<R, P1> getter1,
            String name2, Codec<P2> codec2, Function<R, P2> getter2,
            String name3, Codec<P3> codec3, Function<R, P3> getter3,
            String name4, Codec<P4> codec4, Function<R, P4> getter4,
        ...
        return new Codec<>() {
            ...
            public @NotNull <D> Result<R> decode(@NotNull Transcoder<D> coder, @NotNull D value) {
                ...
                if (!(result8 instanceof Result.Ok(P8 value8)))
                    return result8.cast();
                final Result<P9> result9 = get(coder, codec9, name9, value);
    ...
    public static <R, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10> Codec<R> struct(
            String name1, Codec<P1> codec1, Function<R, P1> getter1,
            String name2, Codec<P2> codec2, Function<R, P2> getter2,
            String name3, Codec<P3> codec3, Function<R, P3> getter3,
            String name4, Codec<P4> codec4, Function<R, P4> getter4,
        ...
        return new Codec<>() {
            ...
            public @NotNull <D> Result<R> decode(@NotNull Transcoder<D> coder, @NotNull D value) {
                ...
                if (!(result9 instanceof Result.Ok(P9 value9)))
                    return result9.cast();
                final Result<P10> result10 = get(coder, codec10, name10, value);
    ...
    public static <R, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11> Codec<R> struct(
            String name1, Codec<P1> codec1, Function<R, P1> getter1,
            String name2, Codec<P2> codec2, Function<R, P2> getter2,
            String name3, Codec<P3> codec3, Function<R, P3> getter3,
            String name4, Codec<P4> codec4, Function<R, P4> getter4,
        ...
        return new Codec<>() {
            ...
            public @NotNull <D> Result<R> decode(@NotNull Transcoder<D> coder, @NotNull D value) {
                ...
                if (!(result10 instanceof Result.Ok(P10 value10)))
                    return result10.cast();
                final Result<P11> result11 = get(coder, codec11, name11, value);
    ...
    public static <R, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12> Codec<R> struct(
            String name1, Codec<P1> codec1, Function<R, P1> getter1,
            String name2, Codec<P2> codec2, Function<R, P2> getter2,
            String name3, Codec<P3> codec3, Function<R, P3> getter3,
            String name4, Codec<P4> codec4, Function<R, P4> getter4,
        ...
        return new Codec<>() {
            ...
            public @NotNull <D> Result<R> decode(@NotNull Transcoder<D> coder, @NotNull D value) {
                ...
                if (!(result11 instanceof Result.Ok(P11 value11)))
                    return result11.cast();
                final Result<P12> result12 = get(coder, codec12, name12, value);
    ...
    public static <R, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13> Codec<R> struct(
            String name1, Codec<P1> codec1, Function<R, P1> getter1,
            String name2, Codec<P2> codec2, Function<R, P2> getter2,
            String name3, Codec<P3> codec3, Function<R, P3> getter3,
            String name4, Codec<P4> codec4, Function<R, P4> getter4,
        ...
        return new Codec<>() {
            ...
            public @NotNull <D> Result<R> decode(@NotNull Transcoder<D> coder, @NotNull D value) {
                ...
                if (!(result12 instanceof Result.Ok(P12 value12)))
                    return result12.cast();
                final Result<P13> result13 = get(coder, codec13, name13, value);
    ...
    public static <R, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14> Codec<R> struct(
            String name1, Codec<P1> codec1, Function<R, P1> getter1,
            String name2, Codec<P2> codec2, Function<R, P2> getter2,
            String name3, Codec<P3> codec3, Function<R, P3> getter3,
            String name4, Codec<P4> codec4, Function<R, P4> getter4,
        ...
        return new Codec<>() {
            ...
            public @NotNull <D> Result<R> decode(@NotNull Transcoder<D> coder, @NotNull D value) {
                ...
                if (!(result13 instanceof Result.Ok(P13 value13)))
                    return result13.cast();
                final Result<P14> result14 = get(coder, codec14, name14, value);
    ...
    public static <R, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14, P15> Codec<R> struct(
            String name1, Codec<P1> codec1, Function<R, P1> getter1,
            String name2, Codec<P2> codec2, Function<R, P2> getter2,
            String name3, Codec<P3> codec3, Function<R, P3> getter3,
            String name4, Codec<P4> codec4, Function<R, P4> getter4,
        ...
        return new Codec<>() {
            ...
            public @NotNull <D> Result<R> decode(@NotNull Transcoder<D> coder, @NotNull D value) {
                ...
                if (!(result14 instanceof Result.Ok(P14 value14)))
                    return result14.cast();
                final Result<P15> result15 = get(coder, codec15, name15, value);
    ...
    public static <R, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14, P15, P16> Codec<R> struct(
            String name1, Codec<P1> codec1, Function<R, P1> getter1,
            String name2, Codec<P2> codec2, Function<R, P2> getter2,
            String name3, Codec<P3> codec3, Function<R, P3> getter3,
            String name4, Codec<P4> codec4, Function<R, P4> getter4,
        ...
        return new Codec<>() {
            ...
            public @NotNull <D> Result<R> decode(@NotNull Transcoder<D> coder, @NotNull D value) {
                ...
                if (!(result15 instanceof Result.Ok(P15 value15)))
                    return result15.cast();
                final Result<P16> result16 = get(coder, codec16, name16, value);
    ...
    public static <R, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14, P15, P16, P17> Codec<R> struct(
            String name1, Codec<P1> codec1, Function<R, P1> getter1,
            String name2, Codec<P2> codec2, Function<R, P2> getter2,
            String name3, Codec<P3> codec3, Function<R, P3> getter3,
            String name4, Codec<P4> codec4, Function<R, P4> getter4,
        ...
        return new Codec<>() {
            ...
            public @NotNull <D> Result<R> decode(@NotNull Transcoder<D> coder, @NotNull D value) {
                ...
                if (!(result16 instanceof Result.Ok(P16 value16)))
                    return result16.cast();
                final Result<P17> result17 = get(coder, codec17, name17, value);
    ...
    public static <R, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14, P15, P16, P17, P18> Codec<R> struct(
            String name1, Codec<P1> codec1, Function<R, P1> getter1,
            String name2, Codec<P2> codec2, Function<R, P2> getter2,
            String name3, Codec<P3> codec3, Function<R, P3> getter3,
            String name4, Codec<P4> codec4, Function<R, P4> getter4,
        ...
        return new Codec<>() {
            ...
            public @NotNull <D> Result<R> decode(@NotNull Transcoder<D> coder, @NotNull D value) {
                ...
                if (!(result17 instanceof Result.Ok(P17 value17)))
                    return result17.cast();
                final Result<P18> result18 = get(coder, codec18, name18, value);
    ...
    public static <R, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14, P15, P16, P17, P18, P19> Codec<R> struct(
            String name1, Codec<P1> codec1, Function<R, P1> getter1,
            String name2, Codec<P2> codec2, Function<R, P2> getter2,
            String name3, Codec<P3> codec3, Function<R, P3> getter3,
            String name4, Codec<P4> codec4, Function<R, P4> getter4,
        ...
        return new Codec<>() {
            ...
            public @NotNull <D> Result<R> decode(@NotNull Transcoder<D> coder, @NotNull D value) {
                ...
                if (!(result18 instanceof Result.Ok(P18 value18)))
                    return result18.cast();
                final Result<P19> result19 = get(coder, codec19, name19, value);
    ...
    public static <R, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14, P15, P16, P17, P18, P19, P20> Codec<R> struct(
            String name1, Codec<P1> codec1, Function<R, P1> getter1,
            String name2, Codec<P2> codec2, Function<R, P2> getter2,
            String name3, Codec<P3> codec3, Function<R, P3> getter3,
            String name4, Codec<P4> codec4, Function<R, P4> getter4,
        ...
        return new Codec<>() {
            ...
            public @NotNull <D> Result<R> decode(@NotNull Transcoder<D> coder, @NotNull D value) {
                ...
                if (!(result19 instanceof Result.Ok(P19 value19)))
                    return result19.cast();
                final Result<P20> result20 = get(coder, codec20, name20, value);
    ...
    private static <D, T> @NotNull Result<T> get(@NotNull Transcoder<D> coder, @NotNull Codec<T> codec, @NotNull String key, @NotNull D value) {
        if (codec instanceof CodecImpl.OptionalImpl<T> optional && !coder.hasValue(value, key))
            return new Result.Ok<>(optional.defaultValue());
        final Result<D> result = coder.getValue(value, key);
        if (!(result instanceof Result.Ok(D innerValue)))
            return result.cast();
        return codec.decode(coder, innerValue);
    }
