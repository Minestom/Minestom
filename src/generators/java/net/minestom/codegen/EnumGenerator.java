...
public class EnumGenerator implements CodeGenerator {
    ...
    public String generate() {
        ...
        if(parameters.length != 0) {
            ...
            for(String property : parameters) {
                ...
                String type = parts[0];
                String name = parts[1];
                builder.append(INDENTATION).append(INDENTATION);
        ...
        for(Method m : methods) {
            ...
            for(String line : m.lines) {
                builder.append(INDENTATION).append(INDENTATION).append(line).append("\n");
            }
    ...
    public void appendToConstructor(String... lines) {
        for(String line : lines) {
            constructorEnd.append(INDENTATION).append(INDENTATION);
            constructorEnd.append(line).append("\n");
        }
    }
