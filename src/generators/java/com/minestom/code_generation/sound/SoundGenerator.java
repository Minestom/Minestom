...
public final class SoundGenerator extends MinestomCodeGenerator {
    ...
    public void generate() {
        ...
        ClassName itemClassName = ClassName.get("net.minestom.server.sound", "SoundEvent");
        // Sound
        TypeSpec.Builder soundClass = TypeSpec.classBuilder(itemClassName)
        ...
        for (JsonElement s : sounds) {
            ...
            String itemName = sound.get("name").getAsString();
