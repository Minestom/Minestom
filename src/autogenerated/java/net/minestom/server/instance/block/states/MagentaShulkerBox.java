...
public final class MagentaShulkerBox {
  public static final BlockState MAGENTA_SHULKER_BOX_0 = new BlockState(NamespaceID.from("minecraft:magenta_shulker_box:0"), (short) 9294, Block.MAGENTA_SHULKER_BOX, "facing=north");

  public static final BlockState MAGENTA_SHULKER_BOX_1 = new BlockState(NamespaceID.from("minecraft:magenta_shulker_box:1"), (short) 9295, Block.MAGENTA_SHULKER_BOX, "facing=east");

  public static final BlockState MAGENTA_SHULKER_BOX_2 = new BlockState(NamespaceID.from("minecraft:magenta_shulker_box:2"), (short) 9296, Block.MAGENTA_SHULKER_BOX, "facing=south");

  public static final BlockState MAGENTA_SHULKER_BOX_3 = new BlockState(NamespaceID.from("minecraft:magenta_shulker_box:3"), (short) 9297, Block.MAGENTA_SHULKER_BOX, "facing=west");
