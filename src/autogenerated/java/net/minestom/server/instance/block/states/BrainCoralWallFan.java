...
public final class BrainCoralWallFan {
  ...
  static {
    ...
    Registries.registerBlockState(BRAIN_CORAL_WALL_FAN_1);
    Registries.registerBlockState(BRAIN_CORAL_WALL_FAN_2);
    Registries.registerBlockState(BRAIN_CORAL_WALL_FAN_3);
    Registries.registerBlockState(BRAIN_CORAL_WALL_FAN_4);
    Registries.registerBlockState(BRAIN_CORAL_WALL_FAN_5);
    Registries.registerBlockState(BRAIN_CORAL_WALL_FAN_6);
    Registries.registerBlockState(BRAIN_CORAL_WALL_FAN_7);
  }
