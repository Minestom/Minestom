...
public final class TubeCoralWallFan {
  public static final BlockState TUBE_CORAL_WALL_FAN_0 = new BlockState(NamespaceID.from("minecraft:tube_coral_wall_fan:0"), (short) 9604, Block.TUBE_CORAL_WALL_FAN, "facing=north","waterlogged=true");

  public static final BlockState TUBE_CORAL_WALL_FAN_1 = new BlockState(NamespaceID.from("minecraft:tube_coral_wall_fan:1"), (short) 9605, Block.TUBE_CORAL_WALL_FAN, "facing=north","waterlogged=false");

  public static final BlockState TUBE_CORAL_WALL_FAN_2 = new BlockState(NamespaceID.from("minecraft:tube_coral_wall_fan:2"), (short) 9606, Block.TUBE_CORAL_WALL_FAN, "facing=south","waterlogged=true");

  public static final BlockState TUBE_CORAL_WALL_FAN_3 = new BlockState(NamespaceID.from("minecraft:tube_coral_wall_fan:3"), (short) 9607, Block.TUBE_CORAL_WALL_FAN, "facing=south","waterlogged=false");

  public static final BlockState TUBE_CORAL_WALL_FAN_4 = new BlockState(NamespaceID.from("minecraft:tube_coral_wall_fan:4"), (short) 9608, Block.TUBE_CORAL_WALL_FAN, "facing=west","waterlogged=true");

  public static final BlockState TUBE_CORAL_WALL_FAN_5 = new BlockState(NamespaceID.from("minecraft:tube_coral_wall_fan:5"), (short) 9609, Block.TUBE_CORAL_WALL_FAN, "facing=west","waterlogged=false");
