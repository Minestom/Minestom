...
public class Particle implements Keyed, PublicCloneable<Particle> {
    ...
    public static final Particle BLOCK = new Particle(NamespaceID.from("minecraft:block"), new BlockParticleEffect(Block.STONE.getDefaultBlockStateId()));

    public static Particle Block(@NotNull BlockState state) {
        return BLOCK.with(new BlockParticleEffect(state));
    }
    ...
    public static final Particle DUST = new Particle(NamespaceID.from("minecraft:dust"), new DustParticleEffect(new Color(0, 0, 0), 1));

    public static Particle Dust(@NotNull Color color, float scale) {
        return DUST.with(new DustParticleEffect(color, scale));
    }
    ...
    public static final Particle FALLING_DUST = new Particle(NamespaceID.from("minecraft:falling_dust"), new BlockParticleEffect(Block.STONE.getDefaultBlockStateId()));

    public static Particle FallingDust(@NotNull BlockState state) {
        return FALLING_DUST.with(new BlockParticleEffect(state));
    }
    ...
    public static final Particle ITEM = new Particle(NamespaceID.from("minecraft:item"), new ItemParticleEffect(ItemStack.AIR));

    public static Particle Item(@NotNull ItemStack stack) {
        return ITEM.with(new ItemParticleEffect(stack));
    }
    ...
    public @NotNull ParticleBuilder builder() {
