...
public enum Material {
	...
	TURTLE_HELMET("minecraft:turtle_helmet", 1, null),
	SCUTE("minecraft:scute", 64, null),
	IRON_SHOVEL("minecraft:iron_shovel", 1, null),
	IRON_PICKAXE("minecraft:iron_pickaxe", 1, null),
	IRON_AXE("minecraft:iron_axe", 1, null),
	FLINT_AND_STEEL("minecraft:flint_and_steel", 1, null),
	APPLE("minecraft:apple", 64, null),
	BOW("minecraft:bow", 1, null),
	...
	IRON_SWORD("minecraft:iron_sword", 1, null),
	WOODEN_SWORD("minecraft:wooden_sword", 1, null),
	WOODEN_SHOVEL("minecraft:wooden_shovel", 1, null),
	WOODEN_PICKAXE("minecraft:wooden_pickaxe", 1, null),
	WOODEN_AXE("minecraft:wooden_axe", 1, null),
	STONE_SWORD("minecraft:stone_sword", 1, null),
	STONE_SHOVEL("minecraft:stone_shovel", 1, null),
	STONE_PICKAXE("minecraft:stone_pickaxe", 1, null),
	STONE_AXE("minecraft:stone_axe", 1, null),
	DIAMOND_SWORD("minecraft:diamond_sword", 1, null),
	DIAMOND_SHOVEL("minecraft:diamond_shovel", 1, null),
	DIAMOND_PICKAXE("minecraft:diamond_pickaxe", 1, null),
	DIAMOND_AXE("minecraft:diamond_axe", 1, null),
	STICK("minecraft:stick", 64, null),
	BOWL("minecraft:bowl", 64, null),
	MUSHROOM_STEW("minecraft:mushroom_stew", 1, null),
	GOLDEN_SWORD("minecraft:golden_sword", 1, null),
	GOLDEN_SHOVEL("minecraft:golden_shovel", 1, null),
	GOLDEN_PICKAXE("minecraft:golden_pickaxe", 1, null),
	GOLDEN_AXE("minecraft:golden_axe", 1, null),
	NETHERITE_SWORD("minecraft:netherite_sword", 1, null),
	NETHERITE_SHOVEL("minecraft:netherite_shovel", 1, null),
	NETHERITE_PICKAXE("minecraft:netherite_pickaxe", 1, null),
	NETHERITE_AXE("minecraft:netherite_axe", 1, null),
	STRING("minecraft:string", 64, null),
	FEATHER("minecraft:feather", 64, null),
	GUNPOWDER("minecraft:gunpowder", 64, null),
	WOODEN_HOE("minecraft:wooden_hoe", 1, null),
	STONE_HOE("minecraft:stone_hoe", 1, null),
	IRON_HOE("minecraft:iron_hoe", 1, null),
	DIAMOND_HOE("minecraft:diamond_hoe", 1, null),
	GOLDEN_HOE("minecraft:golden_hoe", 1, null),
	NETHERITE_HOE("minecraft:netherite_hoe", 1, null),
	WHEAT_SEEDS("minecraft:wheat_seeds", 64, null),
	WHEAT("minecraft:wheat", 64, Block.WHEAT),
	BREAD("minecraft:bread", 64, null),
	LEATHER_HELMET("minecraft:leather_helmet", 1, null),
	LEATHER_CHESTPLATE("minecraft:leather_chestplate", 1, null),
	LEATHER_LEGGINGS("minecraft:leather_leggings", 1, null),
	LEATHER_BOOTS("minecraft:leather_boots", 1, null),
	CHAINMAIL_HELMET("minecraft:chainmail_helmet", 1, null),
	CHAINMAIL_CHESTPLATE("minecraft:chainmail_chestplate", 1, null),
	CHAINMAIL_LEGGINGS("minecraft:chainmail_leggings", 1, null),
	CHAINMAIL_BOOTS("minecraft:chainmail_boots", 1, null),
	IRON_HELMET("minecraft:iron_helmet", 1, null),
	IRON_CHESTPLATE("minecraft:iron_chestplate", 1, null),
	IRON_LEGGINGS("minecraft:iron_leggings", 1, null),
	IRON_BOOTS("minecraft:iron_boots", 1, null),
	DIAMOND_HELMET("minecraft:diamond_helmet", 1, null),
	DIAMOND_CHESTPLATE("minecraft:diamond_chestplate", 1, null),
	DIAMOND_LEGGINGS("minecraft:diamond_leggings", 1, null),
	DIAMOND_BOOTS("minecraft:diamond_boots", 1, null),
	GOLDEN_HELMET("minecraft:golden_helmet", 1, null),
	GOLDEN_CHESTPLATE("minecraft:golden_chestplate", 1, null),
	GOLDEN_LEGGINGS("minecraft:golden_leggings", 1, null),
	GOLDEN_BOOTS("minecraft:golden_boots", 1, null),
	NETHERITE_HELMET("minecraft:netherite_helmet", 1, null),
	NETHERITE_CHESTPLATE("minecraft:netherite_chestplate", 1, null),
	NETHERITE_LEGGINGS("minecraft:netherite_leggings", 1, null),
	NETHERITE_BOOTS("minecraft:netherite_boots", 1, null),
	...
	FISHING_ROD("minecraft:fishing_rod", 1, null),
	...
	SHEARS("minecraft:shears", 1, null),
	...
	CARROT_ON_A_STICK("minecraft:carrot_on_a_stick", 1, null),
	...
	SHIELD("minecraft:shield", 1, null),
	ELYTRA("minecraft:elytra", 1, null),
	...
	TRIDENT("minecraft:trident", 1, null),
