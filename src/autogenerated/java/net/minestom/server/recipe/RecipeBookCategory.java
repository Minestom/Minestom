...
public enum RecipeBookCategory implements StaticProtocolObject {
    CRAFTING_BUILDING_BLOCKS(Key.key("crafting_building_blocks")),

    CRAFTING_REDSTONE(Key.key("crafting_redstone")),

    CRAFTING_EQUIPMENT(Key.key("crafting_equipment")),

    CRAFTING_MISC(Key.key("crafting_misc")),

    FURNACE_FOOD(Key.key("furnace_food")),

    FURNACE_BLOCKS(Key.key("furnace_blocks")),

    FURNACE_MISC(Key.key("furnace_misc")),

    BLAST_FURNACE_BLOCKS(Key.key("blast_furnace_blocks")),

    BLAST_FURNACE_MISC(Key.key("blast_furnace_misc")),

    SMOKER_FOOD(Key.key("smoker_food")),

    STONECUTTER(Key.key("stonecutter")),

    SMITHING(Key.key("smithing")),

    CAMPFIRE(Key.key("campfire"));
