...
public final class Registries {
  public static final IdCrossMapRegistry.Defaulted<Block> blockRegistry = new IdCrossMapRegistry.Defaulted<>(() -> getBlock("minecraft:air"));
  ;

  public static final IdCrossMapRegistry.Defaulted<BlockState> blockStateRegistry = new IdCrossMapRegistry.Defaulted<>(() -> getBlockState("minecraft:air:0"));
  ;

  public static final MapRegistry<BlockEntity> blockEntityRegistry = new MapRegistry<>();
  ;

  public static final IdCrossMapRegistry.Defaulted<Fluid> fluidRegistry = new IdCrossMapRegistry.Defaulted<>(() -> getFluid("minecraft:empty"));
  ;

  public static final IdCrossMapRegistry.Defaulted<Material> materialRegistry = new IdCrossMapRegistry.Defaulted<>(() -> getMaterial("minecraft:air"));
  ;
  ...
  public static final IdCrossMapRegistry<VillagerProfession> villagerProfessionRegistry = new IdCrossMapRegistry<>();
  ;

  public static final IdCrossMapRegistry<VillagerType> villagerTypeRegistry = new IdCrossMapRegistry<>();
  ;

  public static final IdCrossMapRegistry<Particle> particleRegistry = new IdCrossMapRegistry<>();
  ;

  public static final MapRegistry.Defaulted<PotionType> potionTypeRegistry = new MapRegistry.Defaulted<>(() -> getPotionType("minecraft:empty"));
  ;
  ...
  /**
   * Returns the corresponding Block matching the given id. Returns 'minecraft:air' if none match.
   */
  @NotNull
  ...
  /**
   * Returns the corresponding Block matching the given key. Returns 'minecraft:air' if none match.
   */
  @NotNull
  ...
  /**
   * Returns the corresponding BlockState matching the given id. Returns 'minecraft:air:0' if none match.
   */
  @NotNull
  ...
  /**
   * Returns the corresponding BlockState matching the given key. Returns 'minecraft:air:0' if none match.
   */
  @NotNull
  ...
  /**
   * Returns the corresponding Fluid matching the given id. Returns 'minecraft:empty' if none match.
   */
  @NotNull
  ...
  /**
   * Returns the corresponding Fluid matching the given key. Returns 'minecraft:empty' if none match.
   */
  @NotNull
  ...
  /**
   * Returns the corresponding Material matching the given id. Returns 'minecraft:air' if none match.
   */
  @NotNull
  ...
  /**
   * Returns the corresponding Material matching the given key. Returns 'minecraft:air' if none match.
   */
  @NotNull
  ...
  public static int getVillagerProfessionId(@NotNull VillagerProfession villagerprofession) {
    return villagerProfessionRegistry.getId(villagerprofession);
  }

  @Nullable
  public static VillagerProfession getVillagerProfession(int id) {
    return villagerProfessionRegistry.get((short) id);
  }
  ...
  public static int getVillagerTypeId(@NotNull VillagerType villagertype) {
    return villagerTypeRegistry.getId(villagertype);
  }

  @Nullable
  public static VillagerType getVillagerType(int id) {
    return villagerTypeRegistry.get((short) id);
  }
  ...
  /**
   * Returns the corresponding PotionType matching the given id. Returns 'minecraft:empty' if none match.
   */
  @NotNull
  ...
  /**
   * Returns the corresponding PotionType matching the given key. Returns 'minecraft:empty' if none match.
   */
  @NotNull
