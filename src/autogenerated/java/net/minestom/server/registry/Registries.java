...
public final class Registries {
    ...
    private static final IdCrossMapRegistry.Defaulted<BlockState> blockStateRegistry = new IdCrossMapRegistry.Defaulted<>(BlockState.AIR_0);

    private static final MapRegistry<BlockEntity> blockEntityRegistry = new MapRegistry<>();
     ...
     * Adds the given Block to the registiry with the given id. Returns false if the Block or the id is already registered.
     */
    public static boolean registerBlockState(@NotNull BlockState block) {
        return blockStateRegistry.register(block);
    }

    public static int getBlockStateId(@NotNull BlockState block) {
        return blockStateRegistry.getId(block);
    }
    ...
    @Nullable
    public static List<BlockEntity> getBlockEntitys() {
