...
public interface BuiltinRegistries {
     ...
     */
    RegistryKey<Registry<? extends SoundEvent>> SOUND_EVENT = RegistryKey.unsafeOf("sound_event");
    ...
    /**
     * The static registry key for {@link DyeColor}
     */
    RegistryKey<Registry<DyeColor>> DYE_COLORS = RegistryKey.unsafeOf("dye_colors");
    ...
    /**
     * The static registry key for {@link RecipeType}
     */
    RegistryKey<Registry<RecipeType>> RECIPE_TYPES = RegistryKey.unsafeOf("recipe_types");

    /**
     * The static registry key for {@link RecipeDisplayType}
     */
    RegistryKey<Registry<RecipeDisplayType>> RECIPE_DISPLAY_TYPES = RegistryKey.unsafeOf("recipe_display_types");

    /**
     * The static registry key for {@link SlotDisplayType}
     */
    RegistryKey<Registry<SlotDisplayType>> SLOT_DISPLAY_TYPES = RegistryKey.unsafeOf("slot_display_types");

    /**
     * The static registry key for {@link RecipeBookCategory}
     */
    RegistryKey<Registry<RecipeBookCategory>> RECIPE_BOOK_CATEGORIES = RegistryKey.unsafeOf("recipe_book_categories");

    /**
     * The static registry key for {@link ConsumeEffect}
     */
    RegistryKey<Registry<ConsumeEffect>> CONSUME_EFFECTS = RegistryKey.unsafeOf("consume_effects");

    /**
     * The static registry key for {@link ArgumentParserType}
     */
    RegistryKey<Registry<ArgumentParserType>> COMMAND_ARGUMENTS = RegistryKey.unsafeOf("command_arguments");

    /**
     * The static registry key for {@link VillagerType}
     */
    RegistryKey<Registry<VillagerType>> VILLAGER_TYPES = RegistryKey.unsafeOf("villager_types");

    /**
     * The static registry key for {@link WorldEvent}
     */
    RegistryKey<Registry<WorldEvent>> WORLD_EVENTS = RegistryKey.unsafeOf("world_events");
