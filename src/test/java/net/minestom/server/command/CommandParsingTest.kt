...
class CommandParsingTest {
    ...
    fun findCommand() {
        ...
        Assertions.assertEquals(command1, dispatcher.findCommand("name"))
    ...
    fun parseDefault() {
        ...
        command.defaultExecutor = CommandExecutor { s: CommandSender?, context: CommandContext? -> data.set("default") }
        dispatcher.register(command)
        dispatcher.execute(sender, "name")
        Assertions.assertEquals("default", data.get())
    }
    ...
    fun parseLiteral() {
        ...
        command.defaultExecutor = CommandExecutor { s: CommandSender?, context: CommandContext? -> data.set("default") }
        command.addSyntax(
            { s: CommandSender?, context: CommandContext? -> data.set("literal") },
            Literal("literal")
        )
        dispatcher.register(command)
        dispatcher.execute(sender, "name")
        ...
        Assertions.assertEquals("literal", data.get())
