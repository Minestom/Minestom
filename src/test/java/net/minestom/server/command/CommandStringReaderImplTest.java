...
public class CommandStringReaderImplTest {
    @Test
    public void searchTest() {
        final CommandStringReaderImpl reader = new CommandStringReaderImpl("0123456789ABCDEF0123456789ABCDEF");
    ...
    @Test
    public void readRaw() {
        final CommandStringReaderImpl reader = new CommandStringReaderImpl("0123456789ABCDEF");
    ...
    public void readWords() {
        final CommandStringReaderImpl reader = new CommandStringReaderImpl("test 15 foo bar a");
    ...
    public void readWordsAndQuotedStringsMixed() {
        final CommandStringReaderImpl reader = new CommandStringReaderImpl("\"te\\\"st\" 15 foo \"bar\" \"\\\"a\\\"\"");
    ...
    private int jsonTest(String input) {
        return new CommandStringReaderImpl(input).getClosingIndexOfJsonObject(0);
    }
}
