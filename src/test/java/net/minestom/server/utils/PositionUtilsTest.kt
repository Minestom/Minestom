...
class PositionUtilsTest {
    @Test
    fun yaw() {
        val plusX = getLookYaw(10.0, 0.0)
        Assertions.assertEquals(-90.0, plusX.toDouble(), 1E-5)
        val plusZ = getLookYaw(0.0, 10.0)
        Assertions.assertEquals(0.0, plusZ.toDouble(), 1E-5)
        val minusX = getLookYaw(-10.0, 0.0)
        Assertions.assertEquals(90.0, minusX.toDouble(), 1E-5)
        val minusZNegative = getLookYaw(1E-5, -10.0)
        if (minusZNegative < -180) Assertions.fail<Any>()
        Assertions.assertEquals(-180.0, minusZNegative.toDouble(), 1E-4)
        val minusZPositive = getLookYaw(-1E-5, -10.0)
        if (minusZPositive > 180) Assertions.fail<Any>()
        Assertions.assertEquals(180.0, minusZPositive.toDouble(), 1E-4)
        val oneThreeFive = getLookYaw(-5.0, -5.0)
        Assertions.assertEquals(135.0, oneThreeFive.toDouble(), 1E-5)
        val fortyFive = getLookYaw(5.0, 5.0)
        Assertions.assertEquals(-45.0, fortyFive.toDouble(), 1E-5)
    }

    @Test
    fun highPitch() {
        val high = getLookPitch(0.0, 999999.0, 0.0)
        Assertions.assertEquals(-90.0, high.toDouble(), 1E-5)
        val low = getLookPitch(0.0, -999999.0, 0.0)
        Assertions.assertEquals(90.0, low.toDouble(), 1E-5)
        val zero = getLookPitch(-5.0, 0.0, 5.0)
        Assertions.assertEquals(0.0, zero.toDouble(), 1E-5)
        val fortyFive = getLookPitch(5.0, 5.0, 0.0)
        Assertions.assertEquals(-45.0, fortyFive.toDouble(), 1E-5)
    }
}