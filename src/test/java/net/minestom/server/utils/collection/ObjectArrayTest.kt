...
class ObjectArrayTest {
    @Test
    fun testArray() {
        val array = ObjectArray<String>()
        array[50] = "Hey"
        Assertions.assertEquals("Hey", array[50])
        Assertions.assertNull(array[49])
        Assertions.assertNull(array[51])
        array[0] = "Hey2"
        Assertions.assertEquals("Hey2", array[0])
        Assertions.assertEquals("Hey", array[50])
        array.trim()
        Assertions.assertEquals("Hey2", array[0])
        Assertions.assertEquals("Hey", array[50])
        array[250] = "Hey3"
        Assertions.assertEquals("Hey3", array[250])
        Assertions.assertEquals("Hey2", array[0])
        Assertions.assertEquals("Hey", array[50])
        Assertions.assertNull(array[49])
        Assertions.assertNull(array[251])
        Assertions.assertNull(array[Int.MAX_VALUE])
    }
}