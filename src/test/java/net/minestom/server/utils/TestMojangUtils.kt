...
class TestMojangUtils {
    @Test
    fun testValidNameWorks() {
        val result = fromUsername("jeb_")
        Assertions.assertNotNull(result)
        Assertions.assertEquals("jeb_", result!!["name"].asString)
    }

    @Test
    fun testInvalidNameReturnsNull() {
        val result = fromUsername("jfdsa84vvcxadubasdfcvn") // Longer than 16, always invalid
