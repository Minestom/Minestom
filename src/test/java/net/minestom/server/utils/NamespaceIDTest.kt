...
class NamespaceIDTest {
    ...
    fun init() {
        ...
        Assertions.assertEquals("minecraft", namespace.domain())
        Assertions.assertEquals("any", namespace.path())
        Assertions.assertEquals("minecraft:any", namespace.toString())
        namespace = NamespaceID.from("stone")
        Assertions.assertEquals("minecraft", namespace.domain())
        Assertions.assertEquals("stone", namespace.path())
        Assertions.assertEquals("minecraft:stone", namespace.toString())
    }

    @Test
    fun equals() {
        val namespace = NamespaceID.from("minecraft:any")
        Assertions.assertEquals(namespace, NamespaceID.from("minecraft:any"))
        Assertions.assertNotEquals(namespace, NamespaceID.from("minecraft:any2"))
        Assertions.assertEquals(namespace, Key.key("minecraft:any"))
    }

    @Test
    fun atMostOneColon() {
        Assertions.assertThrows(AssertionError::class.java) { NamespaceID.from("minecraft:block:wool") }
    }

    @Test
    fun noSlashInDomain() {
        Assertions.assertThrows(AssertionError::class.java) { NamespaceID.from("minecraft/java_edition:any") }
    }

    @Test
    fun noDotInDomain() {
        Assertions.assertThrows(AssertionError::class.java) { NamespaceID.from("minecraft.java:game") }
    }

    @Test
    fun noUppercase() {
        Assertions.assertThrows(AssertionError::class.java) { NamespaceID.from("Minecraft:any") }
        Assertions.assertThrows(AssertionError::class.java) { NamespaceID.from("minecraft:Any") }
    }

    @Test
    fun noSpace() {
        Assertions.assertThrows(AssertionError::class.java) { NamespaceID.from("minecraft:a n y") }
    }

    @Test
    fun onlyLatinLowercase() {
        Assertions.assertThrows(AssertionError::class.java) { NamespaceID.from("Minecraft:voilà") }
        Assertions.assertThrows(AssertionError::class.java) { NamespaceID.from("minecraft:où_ça") }
        Assertions.assertThrows(AssertionError::class.java) { NamespaceID.from("minecraft:schrödingers_var") }
    }
    ...
    @Test
    fun dotAllowedInPath() {
        NamespaceID.from("minecraft:ambient.cave")
    }

    @Test
    fun slashAllowedInPath() {
