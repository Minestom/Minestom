...
public class PacketUtilsTest {
    ...
    static void translator() {
        ...
        translator.register("test.key", MinestomAdventure.getDefaultLocale(), new MessageFormat("test", MinestomAdventure.getDefaultLocale()));
    ...
    public void testTranslationEnabled(final Env env) {
        ...
        final var collector = connection.trackIncoming(ChatMessagePacket.class, false);
    ...
    public void testTranslationDisabled(final Env env) {
        ...
        final var connection = env.createConnection();
        final var player = connection.connect(instance, new Pos(0, 40, 0)).join();
        final var collector = connection.trackIncoming(CachedPacket.class, false);
        ...
        collector.assertSingle(received -> {
            assertInstanceOf(CachedPacket.class, received);
        });
    }
