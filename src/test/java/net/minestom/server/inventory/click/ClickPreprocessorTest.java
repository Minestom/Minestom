...
public class ClickPreprocessorTest {
    ...
    public void testPickupType() {
        ...
        assertProcessed(new Click.Info.Left(SIZE + 9), clickPacket(PICKUP, 1, 0, 5));
        assertProcessed(null, clickPacket(PICKUP, 1, 0, 99));

        assertProcessed(new Click.Info.Right(0), clickPacket(PICKUP, 1, 1, 0));
        assertProcessed(new Click.Info.Right(SIZE + 9), clickPacket(PICKUP, 1, 1, 5));
    ...
    public void testQuickMoveType() {
        ...
        assertProcessed(new Click.Info.LeftShift(SIZE + 9), clickPacket(QUICK_MOVE, 1, 0, 5));
    ...
    public void testQuickCraft() {
        var processor = new Click.Preprocessor();
        var player = createPlayer();
