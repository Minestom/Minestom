...
class PlayerSlotConversionTest {
    ...
    fun hotbar() {
        ...
        for (i in 0..8) {
            Assertions.assertEquals(i, convertPlayerInventorySlot(i + 36, OFFSET))
        }
    }
    ...
    fun mainInventory() {
        ...
        for (i in 9 until 9 * 4) {
            Assertions.assertEquals(i, convertPlayerInventorySlot(i, OFFSET))
        }
    }

    @Test
    fun armor() {
        Assertions.assertEquals(HELMET_SLOT, 41)
        Assertions.assertEquals(CHESTPLATE_SLOT, 42)
        Assertions.assertEquals(LEGGINGS_SLOT, 43)
        Assertions.assertEquals(BOOTS_SLOT, 44)
        Assertions.assertEquals(OFFHAND_SLOT, 45)

        // Convert 5-8 & 45 into 41-45
        Assertions.assertEquals(HELMET_SLOT, convertPlayerInventorySlot(5, OFFSET))
        Assertions.assertEquals(CHESTPLATE_SLOT, convertPlayerInventorySlot(6, OFFSET))
        Assertions.assertEquals(LEGGINGS_SLOT, convertPlayerInventorySlot(7, OFFSET))
        Assertions.assertEquals(BOOTS_SLOT, convertPlayerInventorySlot(8, OFFSET))
        Assertions.assertEquals(OFFHAND_SLOT, convertPlayerInventorySlot(45, OFFSET))
    }

    @Test
    fun craft() {
        Assertions.assertEquals(CRAFT_RESULT, 36)
        Assertions.assertEquals(CRAFT_SLOT_1, 37)
        Assertions.assertEquals(CRAFT_SLOT_2, 38)
        Assertions.assertEquals(CRAFT_SLOT_3, 39)
        Assertions.assertEquals(CRAFT_SLOT_4, 40)

        // Convert 0-4 into 36-40
        Assertions.assertEquals(CRAFT_RESULT, convertPlayerInventorySlot(0, OFFSET))
        Assertions.assertEquals(CRAFT_SLOT_1, convertPlayerInventorySlot(1, OFFSET))
        Assertions.assertEquals(CRAFT_SLOT_2, convertPlayerInventorySlot(2, OFFSET))
        Assertions.assertEquals(CRAFT_SLOT_3, convertPlayerInventorySlot(3, OFFSET))
        Assertions.assertEquals(CRAFT_SLOT_4, convertPlayerInventorySlot(4, OFFSET))
    }
}