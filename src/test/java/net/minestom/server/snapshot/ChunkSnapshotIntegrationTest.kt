...
class ChunkSnapshotIntegrationTest {
    ...
    fun blocks(env: Env) {
        ...
        Assertions.assertEquals(Block.STONE, inst.getBlock(0, 0, 0))
        Assertions.assertEquals(1, inst.chunks().size)
        val chunk = inst.chunks().iterator().next()
        Assertions.assertEquals(Block.STONE, chunk.getBlock(0, 0, 0))
    }
}