...
class EntityLineOfSightIntegrationTest {
    @Test
    fun entityPhysicsCheckLineOfSight(env: Env) {
        val instance = env.createFlatInstance()
        val entity = Entity(EntityTypes.ZOMBIE)
        entity.setInstance(instance, Pos(0, 42, 0)).join()
        entity.setView(-90f, 0f)
        val entity2 = Entity(EntityTypes.ZOMBIE)
        entity2.setInstance(instance, Pos(10, 42, 0)).join()
        Assertions.assertEquals(entity2, entity.getLineOfSightEntity(20.0) { e: Entity? -> true })
        Assertions.assertTrue(entity.hasLineOfSight(entity2, true))
        for (z in -1..1) {
            for (y in 40..44) {
                instance.setBlock(5, y, z, Block.STONE)
            }
        }
        Assertions.assertNull(entity.getLineOfSightEntity(20.0) { e: Entity? -> true })
        Assertions.assertFalse(entity.hasLineOfSight(entity2, true))
    }

    @Test
    fun entityPhysicsCheckLineOfSightBehind(env: Env) {
        val instance = env.createFlatInstance()
        val entity = Entity(EntityTypes.ZOMBIE)
        entity.setInstance(instance, Pos(0, 42, 0)).join()
        entity.setView(-90f, 0f)
        ...
        Assertions.assertNull(entity.getLineOfSightEntity(20.0) { e: Entity? -> true })
        Assertions.assertFalse(entity.hasLineOfSight(entity2, true))
        Assertions.assertTrue(entity.hasLineOfSight(entity2, false))
        for (z in -1..1) {
            for (y in 40..44) {
                instance.setBlock(-5, y, z, Block.STONE)
            }
        }
        Assertions.assertFalse(entity.hasLineOfSight(entity2, false))
    }

    @Test
    fun entityPhysicsCheckLineOfSightNearMiss(env: Env) {
        val instance = env.createFlatInstance()
        val entity = Entity(EntityTypes.ZOMBIE)
        entity.setInstance(instance, Pos(0, 42, 0)).join()
        entity.setView(-90f, 0f)
        val entity2 = Entity(EntityTypes.ZOMBIE)
        entity2.setInstance(instance, Pos(10, 42, 0.31)).join()
        Assertions.assertNull(entity.getLineOfSightEntity(20.0) { e: Entity? -> true })
        Assertions.assertFalse(entity.hasLineOfSight(entity2, true))
        Assertions.assertTrue(entity.hasLineOfSight(entity2, false))
        for (z in -1..1) {
    ...
    @Test
    fun entityPhysicsCheckLineOfSightNearHit(env: Env) {
        val instance = env.createFlatInstance()
        val entity = Entity(EntityTypes.ZOMBIE)
        entity.setInstance(instance, Pos(0, 42, 0)).join()
        entity.setView(-90f, 0f)
        val entity2 = Entity(EntityTypes.ZOMBIE)
        entity2.setInstance(instance, Pos(10, 42, 0.3)).join()
        Assertions.assertEquals(entity2, entity.getLineOfSightEntity(20.0) { e: Entity? -> true })
        Assertions.assertTrue(entity.hasLineOfSight(entity2, true))
        Assertions.assertTrue(entity.hasLineOfSight(entity2, false))
        for (z in -1..1) {
    ...
    @Test
    fun entityPhysicsCheckLineOfSightCorrectOrder(env: Env) {
        val instance = env.createFlatInstance()
        val entity = Entity(EntityTypes.ZOMBIE)
        entity.setInstance(instance, Pos(0, 42, 0)).join()
        entity.setView(-90f, 0f)
        val entity2 = Entity(EntityTypes.ZOMBIE)
        entity2.setInstance(instance, Pos(10, 42, 0)).join()
        val entity3 = Entity(EntityTypes.ZOMBIE)
        entity3.setInstance(instance, Pos(5, 42, 0)).join()
        Assertions.assertEquals(entity3, entity.getLineOfSightEntity(20.0) { e: Entity? -> true })
        Assertions.assertTrue(entity.hasLineOfSight(entity2, true))
        Assertions.assertTrue(entity.hasLineOfSight(entity2, false))
        Assertions.assertTrue(entity.hasLineOfSight(entity3, true))
        Assertions.assertTrue(entity.hasLineOfSight(entity3, false))
    }

    @Test
    fun entityPhysicsCheckLineOfSightBigMiss(env: Env) {
        val instance = env.createFlatInstance()
        val entity = Entity(EntityTypes.ZOMBIE)
        entity.setInstance(instance, Pos(0, 42, 0)).join()
        entity.setView(-90f, 0f)
        val entity2 = Entity(EntityTypes.ZOMBIE)
        entity2.setInstance(instance, Pos(10, 42, 10)).join()
        Assertions.assertNull(entity.getLineOfSightEntity(20.0) { e: Entity? -> true })
        Assertions.assertFalse(entity.hasLineOfSight(entity2, true))
        Assertions.assertTrue(entity.hasLineOfSight(entity2, false))
    }
    ...
    @Test
    fun entityPhysicsCheckLineOfSightLargeBoundingBox(env: Env) {
        val instance = env.createFlatInstance()
        val entity = Entity(EntityTypes.ZOMBIE)
        entity.setInstance(instance, Pos(0, 42, 0)).join()
        entity.setView(-90f, 0f)
        val entity2 = Entity(EntityTypes.ZOMBIE)
        entity2.setInstance(instance, Pos(6, 42, 0)).join()
