...
class EntityInstanceIntegrationTest {
    ...
    @Test
    fun playerJoin(env: Env) {
        val instance = env.createFlatInstance()
        val player = env.createPlayer(instance, Pos(0, 42, 0))
        Assertions.assertEquals(instance, player.getInstance())
        Assertions.assertEquals(Pos(0, 42, 0), player.getPosition())
    }

    @Test
    fun playerSwitch(env: Env) {
        val instance = env.createFlatInstance()
        val instance2 = env.createFlatInstance()
        ...
        Assertions.assertEquals(instance2, player.getInstance())
    }
}