...
class GameModeTest {
    @Test
    fun toId() {
        Assertions.assertEquals(GameMode.SURVIVAL.id().toInt(), 0)
        Assertions.assertEquals(GameMode.CREATIVE.id().toInt(), 1)
        Assertions.assertEquals(GameMode.ADVENTURE.id().toInt(), 2)
        Assertions.assertEquals(GameMode.SPECTATOR.id().toInt(), 3)
    }

    @Test
    fun fromId() {
        Assertions.assertEquals(GameMode.SURVIVAL, GameMode.fromId(0))
        Assertions.assertEquals(GameMode.CREATIVE, GameMode.fromId(1))
        Assertions.assertEquals(GameMode.ADVENTURE, GameMode.fromId(2))
        Assertions.assertEquals(GameMode.SPECTATOR, GameMode.fromId(3))
    }
}