...
public class EntityVelocityIntegrationTest {
    ...
    public void singleKnockback(Env env) {
        ...
        testMovement(env, entity, new Vec[] {
                ...
                new Vec(0.0, 40.4, 0.4000000059604645),
                new Vec(0.0, 40.71360000610351, 0.6184000345826153),
                new Vec(0.0, 40.94252801654052, 0.8171440663565412),
                new Vec(0.0, 41.088477469609366, 0.9980011404830835),
                new Vec(0.0, 41.153107934874726, 1.1625810826814025),
                new Vec(0.0, 41.138045790541625, 1.3123488343981535),
                new Vec(0.0, 41.04488488728202, 1.4486374923882126),
                new Vec(0.0, 40.87518719878482, 1.5726601747334787),
                new Vec(0.0, 40.630483459294965, 1.685520818920295),
                new Vec(0.0, 40.312273788401676, 1.7882240080901861),
                new Vec(0.0, 40.0, 1.8816839129282854),
                new Vec(0.0, 40.0, 1.9667324287820391),
                new Vec(0.0, 40.0, 2.0131689238319095),
                new Vec(0.0, 40.0, 2.0385232530741106),
                new Vec(0.0, 40.0, 2.052366718448307),
                new Vec(0.0, 40.0, 2.059925251420562),
                new Vec(0.0, 40.0, 2.06405221090277)
        });
    }
