...
public class EntityMetaTest {
    ...
    @Test
    public void ensureRegistration(Env _env) throws IllegalAccessException {
        // This test does not actually need the env, however, the EnvTest annotation requires all tests to have an Env argument
