...
class EventNodeQueryTest {
    ...
    fun find() {
        ...
        Assertions.assertEquals(List.of<Any>(), node.findChildren("test"))
        val child1 = EventNode.all("test")
        val child2 = EventNode.all("test")
        val child3 = EventNode.all("test3")
        node.addChild(child1)
        node.addChild(child2)
        node.addChild(child3)
        Assertions.assertEquals(List.of(child1, child2), node.findChildren("test"))
        Assertions.assertEquals(List.of(child3), node.findChildren("test3"))
        node.removeChild(child1)
        Assertions.assertEquals(List.of(child2), node.findChildren("test"))
        Assertions.assertEquals(List.of(child3), node.findChildren("test3"))
    }
    ...
    fun findType() {
        val node = EventNode.all("main")
        Assertions.assertEquals(List.of<Any>(), node.findChildren("test", Event::class.java))
        val child1 = EventNode.type("test", EventFilter.PLAYER)
        val child2 = EventNode.type("test", EventFilter.ENTITY)
        val child3 = EventNode.type("test3", EventFilter.ENTITY)
        node.addChild(child1)
        node.addChild(child2)
        node.addChild(child3)
        Assertions.assertEquals(List.of(child1, child2), node.findChildren("test", Event::class.java))
        Assertions.assertEquals(List.of(child1, child2), node.findChildren("test", EntityEvent::class.java))
        Assertions.assertEquals(List.of(child1), node.findChildren("test", PlayerEvent::class.java))
        Assertions.assertEquals(List.of(child3), node.findChildren("test3", EntityEvent::class.java))
        node.removeChild(child1)
        Assertions.assertEquals(List.of(child2), node.findChildren("test", Event::class.java))
        Assertions.assertEquals(List.of(child2), node.findChildren("test", EntityEvent::class.java))
        Assertions.assertEquals(List.of<Any>(), node.findChildren("test", PlayerEvent::class.java))
        Assertions.assertEquals(List.of(child3), node.findChildren("test3", EntityEvent::class.java))
    }
    ...
    fun replace() {
        ...
        node.addChild(child2)
        node.addChild(child3)
        val tmp1 = EventNode.all("tmp1")
        val tmp2 = EventNode.all("tmp2")
        node.replaceChildren("test", tmp1)
        Assertions.assertEquals(List.of(child2), node.findChildren("test"))
        Assertions.assertEquals(List.of(tmp1), node.findChildren("tmp1"))
        node.replaceChildren("test3", tmp2)
        Assertions.assertEquals(List.of(child2), node.findChildren("test"))
        Assertions.assertEquals(List.of(tmp1), node.findChildren("tmp1"))
        Assertions.assertEquals(List.of<Any>(), node.findChildren("test3"))
        Assertions.assertEquals(List.of(tmp2), node.findChildren("tmp2"))
    }
}