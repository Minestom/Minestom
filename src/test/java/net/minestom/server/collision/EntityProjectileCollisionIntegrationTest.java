...
public class EntityProjectileCollisionIntegrationTest {
    ...
    public void blockShootAndBlockRemoval(Env env) {
        ...
        assertNotNull(event);
        assertEquals(blockPosition, new Vec(event.getPosition().blockX(), event.getPosition().blockY(), event.getPosition().blockZ()));
        ...
        assertEquals(blockPosition.withY(y -> y - 1), new Vec(event.getPosition().blockX(), event.getPosition().blockY(), event.getPosition().blockZ()));
    }
