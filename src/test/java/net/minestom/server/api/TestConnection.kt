package net.minestom.server.apiimportimport

net.minestom.server.api.*import net.minestom.server.api.TestConnectionimport

net.minestom.server.coordinate.Posimport net.minestom.server.entity.*
...
interface TestConnection {
    fun connect(instance: Instance, pos: Pos): CompletableFuture<Player>
    fun <T : ServerPacket?> trackIncoming(type: Class<T>): Collector<T>
    fun trackIncoming(): Collector<ServerPacket?> {
        return trackIncoming<ServerPacket?>(ServerPacket::class.java)
    }
}