package net.minestom.server.apiimport

import net.minestom.server.api.*
import net.minestom.server.api.EnvParameterResolverimport

org.junit.jupiter.api.extension.ExtensionContextimport org.junit.jupiter.api.extension.ParameterContextimport org.junit.jupiter.api.extension.ParameterResolutionExceptionimport org.junit.jupiter.api.extension.support.TypeBasedParameterResolver net.minestom.server.ServerProcess.ticker
...
internal class EnvParameterResolver : TypeBasedParameterResolver<Env>() {
    @Throws(ParameterResolutionException::class)
    override fun resolveParameter(parameterContext: ParameterContext, extensionContext: ExtensionContext): Env {
        return EnvImpl(updateProcess())
    }
}